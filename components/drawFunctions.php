    ...
    <div id="loginBox">
		<div id="loginWrapper" style="float: left;">
			...
			<p>
				...
				<input onkeypress="handleKey(event,this)" type="email" name="username" id="username" style="position: relative; left: 41px;">
				<br/><br/>
				<label for="password">Password:</label>
				<input onkeypress="handleKey(event,this)" type="password" name="password" id="password" style="position: relative; left: 13px;">
				<div id="credsOut"></div>
			</p>
			<p>
		...
		<form type="post" id="registerForm">
			...
			<p>
				...
				<input type="text" name="fname" id="fname" style="position: relative; left: 5px;">
				<br/><br/>
				<label for="textfield2">Last Name:</label>
				<input type="text" name="lname" id="lname" style="position: relative; left: 7px;">
			</p>
			<p>
				<label for="email">Email:</label>
				<input type="email" name="email" id="newEmail" style="position: relative; left: 42px;">
			</p>
			<p>
				<label for="password2">Password:</label>
				<input type="password" name="password" id="newpassword" style="position: relative; left: 14px;">
			</p>
			<p>
				<label for="password3">Re-Enter Password:</label>
				<input type="password" name="password1" id="renewpassword" style="position: relative; left: 5px;">
			</p>
			<p>
				<input type="submit" name="submit" id="submit" value="Submit">
				<div id="regOut"></div>
